...
logpath = script_dir + '/logs/log.txt'

output = open(logpath,'w') # Point stdout at a file for dumping data to.
call_command('dumpdata','accounts',format='json',indent=3,stdout=output)
output.close()
